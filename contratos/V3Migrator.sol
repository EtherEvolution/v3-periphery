...
import '@etherevolution/v3-core/contracts/libraries/LowGasSafeMath.sol';
import '@etherevolution/v2-core/contracts/interfaces/IEtherEvolutionV2Pair.sol';
...
/// @title EtherEvolution V3 Migrator
contract V3Migrator is IV3Migrator, PeripheryImmutableState, PoolInitializer, Multicall, SelfPermit {
    ...
    function migrate(MigrateParams calldata params) external override {
        ...
        IEtherEvolutionV2Pair(params.pair).transferFrom(msg.sender, params.pair, params.liquidityToMigrate);
        (uint256 amount0V2, uint256 amount1V2) = IEtherEvolutionV2Pair(params.pair).burn(address(this));
